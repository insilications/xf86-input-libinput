...
Source0  : https://www.x.org/releases/individual/driver/xf86-input-libinput-1.1.0.tar.bz2
Source1  : https://www.x.org/releases/individual/driver/xf86-input-libinput-1.1.0.tar.bz2.sig
...
%prep
%setup -q -n xf86-input-libinput-1.1.0
cd %{_builddir}/xf86-input-libinput-1.1.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624489132
...
cp %{_builddir}/xf86-input-libinput-1.1.0/COPYING %{buildroot}/usr/share/package-licenses/xf86-input-libinput/fa42615cf49e7d89b1e2008fe33ff6d00a9b0f5c
%make_install
